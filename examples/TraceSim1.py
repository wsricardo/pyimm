...
# Web: https://www.wsricardo.blogspot.com
...
#Funções usadas para testar algoritmos,códigos, sintaxe-----
def test0():
    print("Olá ")
...
# *args tupla contendo argumentos passado pelo usuario
# **args dicionário contendo argumentos passado pelo usuario:
# function(Key:"Value")
def test2(*args):
    print("Olá")
    print(args)
...
#---Usando espeak
#(using subproccess), call(["espeak","-vpt+f1 ","Ola"])
#(coom os module) os.system("espeak -vpt+f1 'Ola'")
#os.system("espeak -s 140 -vpt+f1 "+msg) msg -> texto p/ ler
#------------Testes------------------------------------------
